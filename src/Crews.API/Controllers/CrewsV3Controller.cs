...
[Route("api/crews")]
public class CrewsV3Controller : ControllerBase
{
    private readonly IMapper _mapper;
    private readonly IOneCrewRepository _repository;
    private readonly ILogger<CrewsV3Controller> _logger;
    private readonly LinkGenerator _linkGenerator;

    public CrewsV3Controller(IOneCrewRepository repository, IMapper mapper, ILogger<CrewsV3Controller> logger, LinkGenerator linkGenerator)
    {
        _mapper = mapper;
